...
{    
    ...
    struct MaskRecord
    {
        ...
        osg::ref_ptr<VTGeometry>      _geom;
        osg::ref_ptr<osg::Vec3Array>  _internal;

        MaskRecord(osg::Vec3dArray* boundary, osg::Vec3d& ndcMin, osg::Vec3d& ndcMax, VTGeometry* geom)
    ...
    void setupMaskRecord(Data& d, osg::Vec3dArray* boundary)
    {
        if ( boundary )
        {
            ...
            if (x_match && y_match)
            {
                VTGeometry* stitchGeom = new VTGeometry( d.model->_tileKey, d.frame, d.textureImageUnit );
...
TileModelCompiler::TileModelCompiler(const MaskLayerVector&              maskLayers,
                                     ...
                                     const VTTerrainEngineOptions& options) :
                           ...
                           ProgressCallback* progress)
{
    ...
    d.surface = new VTGeometry( d.model->_tileKey, d.frame, _textureImageUnit );
